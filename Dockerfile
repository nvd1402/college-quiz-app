...
RUN chmod -R 775 /var/www/college-quiz-app/storage
RUN chmod -R 775 /var/www/college-quiz-app/bootstrap/cache
RUN touch /var/www/college-quiz-app/storage/logs/laravel.log && \
